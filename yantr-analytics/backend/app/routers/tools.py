...
async def export_pdf(request: Request, handle: str):
    ...
    try:
        ...
        filename = f"reachradar_{handle.lstrip('@')}_report.pdf"
...
def _generate_pdf(handle: str, data: dict) -> bytes:
    ...
    # Header
    story.append(Paragraph(f"ReachRadar Ultra — Intelligence Report", title_style))
    ...
    story.append(Paragraph("Generated by ReachRadar Ultra · YantrAnalytics · 2026", meta_style))
